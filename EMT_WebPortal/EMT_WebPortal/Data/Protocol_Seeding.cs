...
namespace EMT_WebPortal.Data
{
    public class Protocol_Seeding
    {
        ...
        public static void SeedDatabase(EMTManualContext context) 
        {
            ...
            {
                new Protocol{Name="AIRWAY AND TRACHEOSTOMY MANAGEMENT", Certification=Certifications.ALL, GuidelineId=1, PatientType=PatientTypes.ADULT, Chart=null, HasAssociatedMedication=false, Medications=null,
                ...
                new Protocol{Name="AIRWAY AND TRACHEOSTOMY MANAGEMENT", Certification=Certifications.ALL, GuidelineId=1, PatientType=PatientTypes.ALL, Chart=null, HasAssociatedMedication=false, Medications=null,
                OtherInformation=null, TreatmentPlan="Ventilate with BVM when apneic or exhibiting respiratory distress. Consider a nasal or oral airway when not contraindicated (facial fractures, intact gag response, etc.), "+
