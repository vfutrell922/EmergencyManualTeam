...
namespace EMT_WebPortal.Data
{
    public class Protocol_Seeding
    {
        ...
        public static void SeedDatabase(EMTManualContext context)
        {
            ...
            {
                new Protocol{Name="AIRWAY AND TRACHEOSTOMY MANAGEMENT", Certification=Certifications.EMT, Guideline="General Patient Care Guidelines", PatientType=PatientTypes.PEDIATRIC, HasAssociatedMedication=false, Medications=null,
